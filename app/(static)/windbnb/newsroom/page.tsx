...
const pressReleases = [
    ...
    { date: "Feb 5, 2026", category: "Milestone", title: "WindBnB Surpasses 1 Million Active Hosts Worldwide", excerpt: "WindBnB celebrates a major milestone as the platform's host community crosses the 1 million mark, spanning 190 countries.", tag: "Milestone", tagColor: "bg-amber-100 text-amber-700" },
    { date: "Jan 22, 2026", category: "Partnership", title: "WindBnB Partners with Leading Airlines for Bundled Travel Packages", excerpt: "A new strategic partnership enables guests to book flights and accommodations together, saving up to 30% on combined travel costs.", tag: "Partnership", tagColor: "bg-purple-100 text-purple-700" },
    { date: "Jan 10, 2026", category: "Report", title: "2025 Annual Report: Revenue Up 42% YoY, Bookings Hit Record High", excerpt: "WindBnB's 2025 annual report reveals record-breaking performance with $2.8 billion in gross revenue and 80 million total nights booked.", tag: "Financial", tagColor: "bg-rose-100 text-rose-700" },
    { date: "Dec 14, 2025", category: "Awards", title: "WindBnB Named World's #1 Travel Platform by Global Travel Awards", excerpt: "For the second consecutive year, WindBnB has been recognized as the leading travel accommodation platform globally.", tag: "Award", tagColor: "bg-indigo-100 text-indigo-700" },
];
            ...
            <section className="py-16 bg-white">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between mb-8">
                        <h2 className="text-2xl font-black text-gray-900">Press Releases</h2>
                        <div className="flex gap-2">
                            {["All", "Product", "Expansion", "Financial"].map((f) => (
                                <button key={f} className={`text-xs font-bold px-3 py-1.5 rounded-full transition-all ${f === "All" ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`}>{f}</button>
                            ))}
                        </div>
                    </div>
